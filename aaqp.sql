...
CREATE TABLE tags(
	id INTEGER PRIMARY KEY,
	name VARCHAR(20) CHECK (name IN ('html', 'css', 'ruby', 'javascript') )
);
...
INSERT INTO questions ('title', 'body', 'author_id')
     VALUES ('Why isnt sqlite pretty?',
						...
						('more than the mandated price. Legal SemiSemiSelling blue jeans
							purlegal legal chased from foreign tourist. Legal Illegal Illegal Sale',
